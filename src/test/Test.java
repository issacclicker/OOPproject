...
public class Test {
    public static void main(String[] args) {
        ...
        if("63".equals(scalar1_1.toString())) {
        ...
        String scalarValue = "50";
        scalar1.setScalar(scalarValue);
        if ("50".equals(scalar1.toString())){
        ...
        if("60".equals(tempscalar.toString())){
        ...
        if("500".equals(tempscalar2.toString())) {
        ...
        if("100".equals(scalar2.toString())){
        ...
        // 04. 벡터3 rand1~rand2-1까지 랜덤 요소로 val2차원 벡터 생성
        int rand1 = 10;
        int rand2 = 100;
        int val2 = 3;
        Vector vector3 = Factory.getVector(rand1, rand2, val2);
        System.out.println("벡터3 "+rand1+"~"+(rand2-1)+"까지 랜덤 요소로 "+val2+"차원 벡터 생성 (04) 값 : ");
        ...
        if(element0.toString().equals("10"))
        {
            System.out.println("성공.");
        }
        else
        ...
        System.out.println("벡터1에 벡터4 더해서 tempVector에 저장: " + tempVector.toString() + " (26)");
        if ("11 \n21 \n31 ".equals(tempVector.toString())) {
            System.out.println("성공.");
        } else {
            System.out.println("실패.");
        }
        ...
        if ("1000 \n2000 \n3000 ".equals(tempVector2.toString())) {
        ...
        System.out.println("vector1에 vector4 더해서 저장 완료 -> " + vector1 + " (20)");
        if("11 \n21 \n31 ".equals(vector1.toString()))
        {
            System.out.println("성공.");
        }
        else
        ...
        if(matrixFromVector1.toString().equals("11 \n21 \n31 "))
        {
            System.out.println("성공.");
        }
        else
        ...
        if("11 21 31 ".equals(matrixFromVector2.toString()))
        {
            System.out.println("성공.");
        }
        else
        ...
        if("150 200 \n250 400 ".equals(vector6.toString())) {
        ...
        if(("100 300 200 \n500 100 400 \n900 600 700 ".equals(matrix2.toString()))){
        ...
        // 07. 행렬4 랜덤(10~99) 2*2 생성
        int randMin_m=10, randMax_m=100, row4 = 2, col4 = 2;  //사용자 설정 값
        ...
        if("250 300 \n150 200 ".equals(matrix1.toString())) {
        ...
        if("300 250 \n200 150 ".equals(matrix1.toString())) {
        ...
        if("300 200 \n250 150 ".equals(transpose.toString())) {
        ...
        if("300 200 ".equals(SubMatrix.toString()))
        {
        ...
        // 37. 행렬1의 1행과 1열을 제외한 부분 행렬 추출
        Matrix SubMatrix2 = matrix1.extractSubMatrix(1, 1);
        if("150 ".equals(SubMatrix2.toString()))
        {
        ...
        if("300 200 ".equals(matrixFromRow1.toString()) && "250 150 ".equals(matrixFromRow2.toString()))
        {
        ...
        if("300 200 \n250 150 ".equals(matrixFromRow1.toString()))
        {
        ...
        if("300 \n250 ".equals(col1.toString()) && "200 \n150 ".equals(col2.toString()))
        {
        ...
        if("300 \n250 ".equals(matrixFromCol1.toString()) && "250 \n150 ".equals(matrixFromCol2.toString()))
        {
        ...
        if("300 200 \n250 150 ".equals(matrixFromCol1.toString()))
        {
        ...
        if(("100 300 200 \n500 100 400 \n900 600 700 ".equals(matrix2.toString()))){
            System.out.println("행렬2 2차원 배열 모양으로 콘솔 출력 성공 :" +  matrix2.toString());
        } else {
            System.out.println("행렬2 2차원 배열 모양으로 콘솔 출력 실패");
        }
        // 13m. 행렬2 크기 정보 조회
        ...
        if("400 600 400 \n1000 100 400 \n1800 600 700 ".equals(matrix2.toString()))
        {
        ...
        if("1600 600 400 \n4400 1300 1200 \n3000 600 700 ".equals(matrix2.toString()))
        {
            System.out.println("49. m번째 행에 n번째 행 상수 k배 더하기 성공 결과 : " + matrix2.toString());
        }
        else
        ...
        // 54. 역행렬 구하기
        Matrix inverse = matrix1.getReversed();
        if("-0,03 0,04 \n0.05 -0.06 ".equals(inverse.toString()))
        {
            System.out.println("성공.");
        }
        else
        ...
        int[][] matrix5_array = {{30, 25}, {20, 15}}; // 사용자 지정 값
        int row5 = 2, col5 = 2 ; //사용자 지정 값
        Matrix matrix5 = Factory.getMatrix(matrix5_array, row5 , col5);
        ...
        if("-50".equals(determinantValue.toString()))
        {
            System.out.println("성공.");
        }
        else
        ...
        Scalar temp6 = Factory.getScalar("99");
